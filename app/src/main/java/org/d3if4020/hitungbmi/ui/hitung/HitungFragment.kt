package org.d3if4020.hitungbmi.ui.hitung
...
import org.d3if4020.hitungbmi.db.BmiDb
...
class HitungFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getNavigasi().observe(viewLifecycleOwner, {
            ...
            actionHitungFragment2ToSaranFragment2(it))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId) {
            R.id.menu_histori -> {
                findNavController().navigate(R.id.action_hitungFragment2_to_historiFragment)
                return true
            }
            R.id.menu_about -> {
                findNavController().navigate(R.id.action_hitungFragment2_to_aboutFragment2)
                return true
            }
        }
